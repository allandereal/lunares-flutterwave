...
namespace Lunar\Flutterwave\Tests\Flutterwave;
...
class MockClient implements ClientInterface
{
    ...
    {
        $this->url = 'https://checkout.flutterwave.com/pay/cs_test_'.Str::random(32);
    }
    ...
    public function request($method, $absUrl, $headers, $params, $hasFile)
    {
        ...
        $policy = config('lunar.flutterwave.policy');
        ...
        // if ($method == "get" && strpos($absUrl, "https://api.flutterwave.com/v1/customers/") === 0) {
        //     $this->rBody = $this->getCustomer(str_replace("https://api.flutterwave.com/v1/customers/", "", $absUrl));
        //     return [$this->rBody, $this->rcode, $this->rheaders];
        // }

        // if ($method == "post" && $absUrl == "https://api.flutterwave.com/v1/customers") {
        //     $this->rBody = $this->getCustomer("cus_".Str::random(14));
        //     return [$this->rBody, $this->rcode, $this->rheaders];
        // }

        // // Handle creating a Flutterwave Checkout session
        // if ($method == "post" && $absUrl == "https://api.flutterwave.com/v1/checkout/sessions") {
